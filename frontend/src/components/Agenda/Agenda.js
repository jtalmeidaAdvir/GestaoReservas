...
const handleShowBlacklist = async () => {
    try {
      const res = await fetch("https://backendreservasnunes.advir.pt/api/blacklist"); // adapta à tua rota
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://backendreservasnunes.advir.pt/api/blacklist/${id}`);
